...
import 'repertorio_igreja_model.dart';
export 'repertorio_igreja_model.dart';

class RepertorioIgrejaWidget extends StatefulWidget {
  const RepertorioIgrejaWidget({super.key});

  @override
  State<RepertorioIgrejaWidget> createState() => _RepertorioIgrejaWidgetState();
}

class _RepertorioIgrejaWidgetState extends State<RepertorioIgrejaWidget> {
  late RepertorioIgrejaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RepertorioIgrejaModel());
