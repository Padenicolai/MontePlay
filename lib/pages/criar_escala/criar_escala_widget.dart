                  ...
                  Container(
                    ...
                    child: FutureBuilder<List<EscalasRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<EscalasRow> listViewEscalasRowList =
                            snapshot.data!;
                                                                      ...
                                                                      Theme(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onChanged:
                                                                              (newValue) async {
                                                                            safeSetState(() =>
                                                                                _model.checkboxValueMap1[listViewVEscalagrupoRow] = newValue!);
                                                                            if (newValue!) {
                                                                              await Future.wait([
                                                                                Future(() async {
                                                                      ...
                                                                      Theme(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onChanged:
                                                                              (newValue) async {
                                                                            safeSetState(() =>
                                                                                _model.checkboxValueMap2[listViewVEscalagrupoRow] = newValue!);
                                                                            if (newValue!) {
                                                                              await Future.wait([
                                                                                Future(() async {
                                                                      ...
                                                                      Theme(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onChanged:
                                                                              (newValue) async {
                                                                            safeSetState(() =>
                                                                                _model.checkboxValueMap3[listViewVEscalagrupoRow] = newValue!);
                                                                            if (newValue!) {
                                                                              await Future.wait([
                                                                                Future(() async {
                                                                      ...
                                                                      Theme(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onChanged:
                                                                              (newValue) async {
                                                                            safeSetState(() =>
                                                                                _model.checkboxValueMap4[listViewVEscalagrupoRow] = newValue!);
                                                                            if (newValue!) {
                                                                              await Future.wait([
                                                                                Future(() async {
