                        ...
                        children: [
                          ...
                          Expanded(
                            child: TabBarView(
                              controller: _model.tabBarController,
                              children: [
                                FutureBuilder<List<VEscalagrupoRow>>(
                                  future: VEscalagrupoTable().queryRows(
                                    queryFn: (q) => q.eq(
                                      'idgrupo',
                                      1,
                                    ),
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          listViewVEscalagrupoRowList.length,
                                      itemBuilder: (context, listViewIndex) {
                                                                    ...
                                                                    Future(
                                                                      ...
                                                                      await NotEscalaTable()
                                                                        ...
                                                                        'titulo':
                                                                            'Nova Escala!',
                                                                        'corpo':
                                                                            'Vamos louvar. Você foi escalado. Confira a data do culto!',
                                                                        'fcmtoken':
                                                                            _model.fcmToken,
                                                                      });
                                                                      _model.fcmToken =
