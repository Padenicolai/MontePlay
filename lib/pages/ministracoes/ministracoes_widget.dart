...
import 'ministracoes_model.dart';
export 'ministracoes_model.dart';

class MinistracoesWidget extends StatefulWidget {
  const MinistracoesWidget({
    super.key,
  ...
  @override
  State<MinistracoesWidget> createState() => _MinistracoesWidgetState();
}

class _MinistracoesWidgetState extends State<MinistracoesWidget> {
  late MinistracoesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MinistracoesModel());
