...
import '/components/add_group_member_chat_widget.dart';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ChatsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChatsRow> groupDetailChatsRowList = snapshot.data!;

        final groupDetailChatsRow = groupDetailChatsRowList.isNotEmpty
            ? groupDetailChatsRowList.first
            : null;
                                  ...
                                  child: FutureBuilder<List<UsuariosRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            membrosGrupoUsuariosRowList.length,
                                        itemBuilder:
                                            (context, membrosGrupoIndex) {
                                          final membrosGrupoUsuariosRow =
                                              membrosGrupoUsuariosRowList[
                                                  membrosGrupoIndex];
                                          return Card(
                                            clipBehavior:
