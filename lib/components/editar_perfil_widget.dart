...
class _EditarPerfilWidgetState extends State<EditarPerfilWidget>
  ...
  void initState() {
    ...
    _model.yourCelTextController ??= TextEditingController();
    _model.yourCelFocusNode ??= FocusNode();
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 8.0, 16.0, 16.0),
                        child: TextFormField(
                          controller: _model.yourCelTextController,
                          focusNode: _model.yourCelFocusNode,
                          autofocus: false,
                          textCapitalization: TextCapitalization.none,
                          ...
                          cursorColor: FlutterFlowTheme.of(context).primary,
                          validator: _model.yourCelTextControllerValidator
                              .asValidator(context),
                          inputFormatters: [_model.yourCelMask],
                        ),
                      ),
                      Row(
                        mainAxisSize: MainAxisSize.max,
                              ...
                              await Future.wait([
                                ...
                                Future(() async {
                                  if (_model.yourNameTextController.text !=
                                    ...
                                    await UsuariosTable().update(
                                      data: {
                                        'nomeUsuario': valueOrDefault<String>(
                                ...
                                Future(() async {
                                  if (_model.datePicked != null) {
                                    await UsuariosTable().update(
                                      data: {
                                        'nascimento': supaSerialize<DateTime>(
                                            _model.datePicked),
                                      },
                                      matchingRows: (rows) => rows
                                          .eq(
                                ...
                                Future(() async {
                                  if (_model.yourCelTextController.text != '') {
                                    await UsuariosTable().update(
                                      data: {
                                        'telefone':
